  ...
  return (
    <SecondaryWrapper>
      <div className="w-full p-0 m-0 flex flex-inline">
        <div className="h-full w-full flex flex-col gap-10 lg:py-10 md:px-20 ml-5 md:mt-14 justify-center m-auto text-start">
          <motion.h1
          ...
          >
            <button className="bg-transparent text-md hover:bg-white text-white font-semibold hover:text-black py-2 px-4 border border-white hover:border-transparent rounded inline-flex">
              Learn More
              <svg
